...
float32_t haning[1024] ;
void haning_num(void) //生成haning数组
{
    int k;
    for(k = 0 ; k < 1024 ; k++)
    {
        haning[k] = 0.5*(1-1*cos(2*k*3.14/1023));
    }
}
...
//                            MAX4 = MAX4;
                  ...
                  if (dis_freq>85000&&dis_freq<95000&&MAX3/MAX<0.1&&MAX2/MAX<0.1&&MAX1/MAX<0.1){MAX4=MAX*0.08;}
...
//rms
                    ...
                    Amplitude_Display(THDx*100,(float)Amp[0],(float)Amp[1],(float)Amp[2],(float)Amp[3],(float)dis_freq/1000,(float)rms);
                    sum=0;
                      ...
                      Wave_Display(Re_Appear,THDx*100);
//                              j=8000000;
                        //      while(j--);
//                        display_wave();
                       // j=8000000;
